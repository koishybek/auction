...
export default {
  ...
  rules: {
    ...
    /**
     * Отключено осознанно. Детектор регистра рассчитан на английские заголовки и
     * на русских даёт ложные срабатывания: «Helm-чарты stage» он считает
     * sentence-case из-за заглавной H. То же случится с NestJS, Prisma,
     * Kubernetes, PostgreSQL — то есть с половиной осмысленных заголовков.
     */
    'subject-case': [0],
  },
};
